  ...
  <div class="navbar-inner">
    ...
    <div class="header-quick-nav" >
      ...
      <div class="pull-right">
        <div class="chat-toggler"> <a href="#" class="dropdown-toggle">
          <div class="user-details">
            <div class="username">  <?php echo $this->session->userdata['admin']['first_name'] ?> <span class="bold"><?php echo $this->session->userdata['admin']['last_name'] ?></span> </div>
          </div>
