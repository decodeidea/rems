	...
	$('body').delegate('.btn-edit','click',function(){
		...
		$.ajax({
			...
			success : function(result){
				...
				$('#old-image').val(result.data.filename);
				$('.image-original-preview').html('<img src="assets/uploads/customer/'+result.data.customer_id+'/'+result.data.filename+'" alt="images" id="original-image"/>');
				$('.image-productimage-crop-preview').html('<img src="assets/uploads/customer/'+result.data.customer_id+'/'+result.data.filename+'" alt="images" id="crop-image"/>');
				origImageVal();
