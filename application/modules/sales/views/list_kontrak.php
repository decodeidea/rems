          ...
          <div class="grid simple ">
            ...
            <div class="grid-body ">
              ...
              <tr>
                ...
                <!-- <td class="text-center"><?php echo $d_row->unit; ?></td> -->
                ...
                <!-- <td class="text-center"><?php echo $d_row->kontrak_type; ?></td> -->
                <td class="text-center">
                  
                    <a data-toggle="tooltip" data-original-title="Detail" href="<?php echo $controller.'/kontrak_detail/'.$d_row->id; ?>" class=" btn btn-default btn-xs btn-mini tip"><i class="fa fa-eye"></i></a>
                    <a target="_blank" data-toggle="tooltip" data-original-title="Download PDF" href="<?php echo base_url()."". $controller.'/kontrak_pdf/'.$d_row->id; ?>" class="btn btn-info btn-xs btn-mini tip" ><i class="fa fa-download"></i></a>
