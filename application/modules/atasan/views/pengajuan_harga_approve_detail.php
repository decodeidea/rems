        ...
        <div class="span12">
          <div class="grid simple ">
            ...
            <div class="grid-body ">
             ...
             <form enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>atasan/pengajuan_harga_approve_status">
              <input type="hidden" value="<?php if($pengajuan!=null) echo $pengajuan->id; ?>" name="id">
               <div class="form-group">
                ...
                <div class="box-back">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-xs-12">
                            <?php echo $pengajuan->nominal_cur;  ?>
                        </div>
                    </div></br>
                    <div class="form-group">
                        <label class="col-md-2 col-xs-12 control-label" for="#px-customer-form-pengajuan-approved-nominal">Approved Nominal</label>
                        <div class="col-md-9 col-xs-12">
                            <input type="text" class="form-control money" name="approved_nominal" id="px-customer-form-pengajuan-approved-nominal" value="<?php if($pengajuan!=null) echo $pengajuan->approved_nominal; ?>">
                        </div>
                    </div>
                    </br>
                    <div class="panel-footer">
                        <button type="submit" value="1" name="status" class="btn btn-primary">Approve</button>

                        <button type="submit" value="2" name="status" class="btn btn-danger">Reject</button>
                    </div>
                    <div class="clearfix"></div>
                </div>
              </form>
