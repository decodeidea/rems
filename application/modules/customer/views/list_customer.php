                  ...
                  <td><?php echo $no ?></td>
                    ...
                    <td>
                      <input type="hidden" name="id" value="<?php echo $data->id; ?>">
                        <a href="<?php echo $controller.'/customer_detail/'.$data->id; ?>" ><button   data-toggle="tooltip" data-original-title="Detail" class="btn btn-warning btn-xs btn-mini tip" type="button"><i class="fa fa-eye"></i></button></a>
                        <a href="<?php echo $controller.'/list_customer_album/'.$data->id; ?>" ><button   data-toggle="tooltip" data-original-title="Album" class="btn btn-warning btn-xs btn-mini tip" type="button"><i class="fa fa-image"></i></button></a>
