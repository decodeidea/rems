...
$('body').delegate('.btn-lunas','click',function(){
	$('#message_box').html('Are you sure want to lunas this contract?');
	$('#px-site-content-static-content-message-form').attr('action', 'administration/lunas_contract');
