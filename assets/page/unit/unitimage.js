	...
	$('body').delegate('.btn-edit','click',function(){
		...
		$.ajax({
			...
			success : function(result){
				...
				$('.image-original-preview').html('<img src="assets/uploads/unit/'+result.data.unit_id+'/'+result.data.filename+'" alt="images" id="original-image"/>');
				$('.image-productimage-crop-preview').html('<img src="assets/uploads/unit/'+result.data.unit_id+'/'+result.data.filename+'" alt="images" id="crop-image"/>');
				origImageVal();
