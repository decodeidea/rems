     ...
     <div class="row-fluid">
        <div class="span12">
          <div class="grid simple ">
            ...
            <div class="grid-body ">
<a id="add_button" href="<?php echo base_url() ?>customer/list_customer_album_form/?unit_id=<?php echo $this->uri->segment('3')?>"><button class="btn btn-primary">Add Image</button></a>
