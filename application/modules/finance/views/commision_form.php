			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-md-2 col-xs-12 control-label" for="#px-site-content-static-content-form-static-content-title">Name</label>
						<div class="col-md-6 col-xs-12">
							<input type="text" class="form-control" name="title" id="px-unit-area-name" value="<?php if($data!=null) echo $data->title; ?>">
						</div>
					</div>
				</div>
